...
// DOM references
const fn5glLeaderboard = document.querySelector(".tsw-fn5gl-leaderboard-regions ");
...
fn5glRegionTabs.addEventListener("click", (event) => {
  ...
  allRegions.forEach((panel) => {
    panel.hidden = panel.getAttribute("aria-labelledby") !== currentRegion;
  });
});
