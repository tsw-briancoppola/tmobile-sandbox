...
// Throttle function
const runConfetti = throttle((fn, ...params) => fn(...params), 1000);
...
//   e5: ["🏈", "✈️", "🤩", "🚗", "🎸"],
//   s1: [svgNetflix],
//   s2: [svgNetflix, svgHulu],
//   s3: [svgNetflix, svgHulu, svgDoordash],
// };

// // Helper to attach listeners safely
// const setupBtn = (id, fn) => document.getElementById(id)?.addEventListener("click", fn);

// // Standard Themes (magenta, football, mixed)
// const themes = [
//   { name: "magenta", emojis: null, times: [2, null, 3] },
//   { name: "football", emojis: emojiSets.football, times: [2, null, 4] },
//   { name: "mixed", emojis: emojiSets.mixed, times: [2, null, null], mixed: true },
// ];

// themes.forEach(({ name, emojis, times, mixed }) => {
//   setupBtn(`tsw-confetti-${name}-button-1`, () =>
//     runConfetti(mixed ? generateConfettiFireworksMixed : generateConfettiFireworks)(times[0], emojis),
//   );
//   setupBtn(`tsw-confetti-${name}-button-2`, () =>
//     runConfetti(mixed ? generateConfettiCornersMixed : generateConfettiCorners)(emojis),
//   );
//   setupBtn(`tsw-confetti-${name}-button-3`, () => runConfetti(generateConfettiRain(times[2], emojis)));
// });

// // Emoji buttons
// [2, 3, 4, 5].forEach((i) => {
//   setupBtn(`tsw-confetti-emojis-button-${i}`, () => runConfetti(generateConfettiFireworksMixed(2, emojiSets[`e${i}`])));
// });

// // SVG buttons
// [1, 2, 3].forEach((i) => {
//   setupBtn(`tsw-confetti-svgs-button-${i}`, () =>
//     runConfetti(generateConfettiFireworksMixed(2, ["🏈"], emojiSets[`s${i}`])),
//   );
// });

document.getElementById("tsw-confetti-magenta-button-1").addEventListener("click", () => {
  runConfetti(generateConfettiFireworksMixed, 2);
});
