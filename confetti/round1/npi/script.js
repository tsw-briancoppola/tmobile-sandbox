...
confettiWrapper.getElementById("tsw-confetti-emojis-button-2").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈"]);
});

confettiWrapper.getElementById("tsw-confetti-emojis-button-3").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈", "✈️", "🤩"]);
});

confettiWrapper.getElementById("tsw-confetti-emojis-button-4").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈", "✈️", "🤩", "🚗"]);
});

confettiWrapper.getElementById("tsw-confetti-emojis-button-5").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈", "✈️", "🤩", "🚗", "🎸"]);
});
...
confettiWrapper.getElementById("tsw-confetti-svgs-button-1").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈"], [svgNetflix]);
});

confettiWrapper.getElementById("tsw-confetti-svgs-button-2").addEventListener("click", () => {
  // Number of seconds and emojis
  generateConfettiFireworksMixed(2, ["🏈"], [svgNetflix, svgHulu]);
});

confettiWrapper.getElementById("tsw-confetti-svgs-button-3").addEventListener("click", () => {
  // Number of seconds and emojis
