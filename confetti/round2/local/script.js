...
const defaults = { zIndex: 0, scalar: 1.4, colors: ["#e20074", "#a61765"] };
...
document.getElementById("tsw-confetti-logos-button-1").addEventListener("click", () => {
...
document.getElementById("tsw-confetti-logos-emojis-button-1").addEventListener("click", () => {
  // Number of corners, emoji array, SVG array
