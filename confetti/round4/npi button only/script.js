...
const defaults = { scalar: 1.4 };

const generateConfetti = ({ corners, ticks, zIndex, particleCount, colors, emojis = [], svgs = [] }) => {
...
const svgTMobileBadgeGray = {
  path: svgPathTMobileBadge,
  color: "a7005a",
  scalar: 7,
};

const svgTMobileTuesdaysGray = {
  path: svgPathTMobileTuesdaysBadge,
  color: "a7005a",
  scalar: 8,
};

const svgPizzaSliceGray = {
  path: svgPathPizzaSlice,
  color: "a7005a",
  scalar: 7,
};

const svgMusicTicketGray = {
  path: svgPathMusicTicket,
  color: "ffffff",
  scalar: 7,
};

const svgGasPumpGray = {
  path: svgPathGasPump,
  color: "111111",
  scalar: 7,
};
...
const confettiColorsMagenta = ["#e20074", "#a7005a", "#770141"];
const confettiColorsGrayscale = ["#ffffff", "#a7005a", "#111111"];
...
const confettiSettings5 = {
  ...
  zIndex: 900,
  particleCount: 1200,
  colors: confettiColorsGrayscale,
  emojis: [],
  svgs: [svgTMobileBadgeGray, svgTMobileTuesdaysGray, svgPizzaSliceGray, svgMusicTicketGray, svgGasPumpGray],
};
