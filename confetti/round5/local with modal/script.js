...
document.getElementById("tsw-confetti-button-5").addEventListener("click", () => {
...
const confettiContainer = document.querySelector(".tsw-confetti-container");
...
document.getElementById("tsw-bg-button-white").addEventListener("click", () => {
  backgroundWhite();
});

document.getElementById("tsw-bg-button-magenta").addEventListener("click", () => {
  backgroundMagenta();
});
