...
confettiWrapper.getElementById("tsw-confetti-button-2").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings2);
});

confettiWrapper.getElementById("tsw-confetti-button-3").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings3);
});

confettiWrapper.getElementById("tsw-confetti-button-4").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings4);
});

confettiWrapper.getElementById("tsw-confetti-button-5").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings5);
});

confettiWrapper.getElementById("tsw-confetti-big-button-1").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings4);
});

confettiWrapper.getElementById("tsw-confetti-big-button-2").addEventListener("click", () => {
  runConfetti(generateConfetti, confettiSettings5);
});

// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
// Background functions and event listeners
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-

const confettiContainer = confettiWrapper.querySelector(".tsw-confetti-container");

const backgroundWhite = () => {
  confettiContainer.classList.remove("magenta-theme");
};

const backgroundMagenta = () => {
  confettiContainer.classList.add("magenta-theme");
};

confettiWrapper.getElementById("tsw-bg-button-white").addEventListener("click", () => {
  backgroundWhite();
});

confettiWrapper.getElementById("tsw-bg-button-magenta").addEventListener("click", () => {
  backgroundMagenta();
});
