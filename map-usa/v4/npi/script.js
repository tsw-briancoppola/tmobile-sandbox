...
const handleTooltip = (thisStateData, isHovering, event, isClick = false) => {
  ...
  const mapContainer = mapUSAWrapper.querySelector(".tsw-map-usa");
...
const modalCloseButton = mapUSAWrapper.querySelector(".tsw-modal-close");
...
const dropdown = mapUSAWrapper.querySelector("#tsw-dropdown-select");
const dropdownDataState = mapUSAWrapper.querySelector(".tsw-dropdown-data-state");
const dropdownDataTotal = mapUSAWrapper.querySelector(".tsw-dropdown-data-total");
